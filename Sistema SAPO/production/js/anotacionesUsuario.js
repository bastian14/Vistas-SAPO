function cargarAnotacionesUsuario(){
  var email = localStorage.getItem("email");
  var pass = localStorage.getItem("pass");
  if(email !== null && pass !== null){

    $.ajax({
      url: 'http://sapo2018.000webhostapp.com/mostrarAnotacionesApoderados.php',
      method: 'POST',
      dataType: 'json',
      data: {
      email: email,
      ...
      success: function(data){
        if(data.resp){
          ...
          for (var i = 0; i < cantidad; i++) {
            ...
            console.log("titulo: "+titulo+" curso: "+curso+" fecha: "+fecha+"tipo: "+tipo+" contenido: "+contenido);
            text_html ='<tr>';
